...
import { X, ArrowRight, Sparkles, Rotate3D } from "lucide-react";
        ...
        >
          ...
          <div className="relative rounded-[2.2rem] p-[1.5px] overflow-hidden">
            ...
            >
              {/* Flip Container */}
              <div
                className={`relative grid [transform-style:preserve-3d] transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
              ...
              >
                ...
                ========================================================== */}
                <div
                  className="relative [grid-area:1/1] rounded-[2.15rem] p-6 sm:p-8 overflow-hidden shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)] [backface-visibility:hidden]"
                  style={{ backgroundColor: NAVY_DEEP }}
                >
                  {/* Front Expanding Border */}
                  <motion.div
                  ...
                  <div className="flex items-start gap-4 relative z-10">
                    ...
                    <div className="flex-1">
                      ...
                      {/* Flip Hint */}
                      <div className="mt-4 flex items-center gap-1.5 text-white/25">
                        <Rotate3D size={12} />
                        <span className="text-[8px] uppercase tracking-[0.18em] font-bold">
                          Tap to explore
                        </span>
                      </div>
                    </div>
                ...
                ========================================================== */}
                <div
                  className="relative [grid-area:1/1] rounded-[2.15rem] p-6 sm:p-8 overflow-hidden shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)] [transform:rotateY(180deg)] [backface-visibility:hidden]"
                  style={{ backgroundColor: NAVY_DEEP }}
                >
                  {/* Back Ambient Glow */}
                  <div
                  ...
                  <div className="absolute -bottom-20 -left-20 w-56 h-56 rounded-full bg-[#12066a] blur-3xl pointer-events-none" />

                  {/* Gold Grid / Decorative Lines */}
                  <div
                  ...
                  {/* Decorative Ring */}
                  <div
                    className="absolute -right-16 -top-16 w-40 h-40 rounded-full border pointer-events-none"
                    style={{ borderColor: `${GOLD}25` }}
                  />

                  <div
                    className="absolute -right-10 -top-10 w-28 h-28 rounded-full border pointer-events-none"
                  ...
                  {/* Back Content */}
                  <div className="relative z-10 flex flex-col min-h-[250px]">
                    {/* Label */}
                    <div className="flex items-center gap-3 mb-6">
                      <div
                        className="w-11 h-11 rounded-2xl flex items-center justify-center"
                        style={{
                          background: `linear-gradient(135deg, ${GOLD}35, ${GOLD}08)`,
                          border: `1px solid ${GOLD}55`,
                          color: GOLD_LIGHT,
                        }}
                      >
                      ...
                      <div>
                        <span
                          className="block text-[9px] uppercase tracking-[0.25em] font-black"
                          style={{ color: GOLD_LIGHT }}
                        >
                          Compliance Savings
                        </span>

                        <span className="block text-white/40 text-[10px] mt-1 uppercase tracking-wider">
                          Explore the offer
                        </span>
                      </div>
                    </div>
                    ...
                    {/* Heading */}
                    <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tight leading-tight text-white mb-3">
                      One Offer.
                      <br />
                      <span
                    ...
                    <p className="text-white/50 text-xs sm:text-sm leading-relaxed mb-5">
                      Save on Health & Safety Compliance Bundles designed to
                      help businesses work towards SSIP readiness with
                      recognised schemes.
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-6">
                      {[
                        ...
                        <div
                          key={item}
                          className="flex items-center gap-2 rounded-xl px-3 py-2.5 border bg-white/[0.03]"
                          style={{ borderColor: `${GOLD}25` }}
                        >
                          <span
                          ...
                          <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-white/65">
                            {item}
                          </span>
                        </div>
                      ))}
                    ...
                    <button
                      ...
                      className="mt-auto inline-flex items-center justify-center gap-2 py-3 px-5 rounded-xl border text-[10px] font-black uppercase tracking-[0.18em] text-white/70 hover:text-white transition-all duration-300 cursor-pointer"
                      style={{
                        borderColor: `${GOLD}45`,
