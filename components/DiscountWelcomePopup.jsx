            ...
            >
              ...
              <div className="flex items-start gap-4 relative z-10">
                ...
                <div className="flex-1">
                  ...
                  >
                  Save on Health & Safety Compliance Bundles. Get SSIP-ready with <span className="text-[#997819] font-bold">CHAS</span>, <span className="text-[#997819] font-bold" >SMAS</span>, <span className="text-[#997819] font-bold">CHAS</span>, <span className="text-[#997819] font-bold" >SafeContractor</span> & <span className="text-[#997819] font-bold">CHAS</span>, <span className="text-[#997819] font-bold" >Constructionline</span>.
                  </motion.p>
