        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[#997819] font-bold text-xs uppercase tracking-[0.4em]">Testimonials</span>
            </div>
            
            <h2 className="text-5xl md:text-8xl font-black text-[#12066a] uppercase tracking-tighter leading-[0.85]">
              Trusted <br /> <span className="text-[#997819]">Partnerships</span>
            </h2>
            
            <p className="text-gray-500 text-lg md:text-xl font-medium max-w-sm leading-relaxed">
              Discover how BizGrow Holdings empowers professionals across the UK through strategic innovation.
            </p>
              ...
              >
                ...
                <div className="flex justify-between items-center mb-10">
                    <div className="flex gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-4 h-4 fill-[#997819] text-[#997819]" />
                      ))}
                    </div>
                    {/* Floating Tag */}
