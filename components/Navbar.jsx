...
export default function Navbar() {
  ...
  return (
  <nav className="relative md:fixed top-10 md:top-6 inset-x-0 mx-4 xl:mx-auto rounded-4xl max-w-7xl z-[100] bg-white backdrop-blur-md border border-[#12066a] shadow-lg mt-0 pt-0">
