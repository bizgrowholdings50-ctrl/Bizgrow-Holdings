...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/bizgrow-hero-home.jpg",
        width: 1200,
        height: 630,
        alt: "BizGrow Holdings - Security Business Growth and Compliance",
      },
    ],
  },
};
        ...
        <section className="py-20 md:py-28 bg-[#12066a] relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
              <span className="px-6 py-2 rounded-full  text-white text-xs md:text-xs font-black tracking-[0.3em] uppercase">
