        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <FadeIn direction="up">
            ...
            <p className="text-blue-100/70 text-lg md:text-xl max-w-2xl font-medium leading-relaxed mb-10">
              Expert guidance to help you launch, structure, and scale a fully
              compliant security business with{" "}
              <Link
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-zinc-600 text-lg mb-6 leading-relaxed">
                Launching a private security startup in the UK can be
                challenging due to strict industry regulations, operational
                requirements, and high client expectations. Without the right
                ...
                systems, many new security businesses struggle to gain
                credibility or win contracts.
              </p>
              <p className="text-[#12066a] font-bold text-lg mb-8 italic">
                At{" "}
                <Link href="/" className="text-[#997819]">
                  BizGrow Holdings
                </Link>
                , we help entrepreneurs build strong and compliant private
                security startups from the ground up.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-zinc-500 mt-6 max-w-3xl mx-auto font-medium">
              Starting a private security startup in the UK requires the right
              systems and{" "}
              <Link
              ...
              . Our consultancy helps you build a strong foundation.
            </p>
          </div>
            ...
            {[
              {
                ...
                d: "Implement systems that improve operational control and service quality.",
                icon: <Settings />,
              },
              {
                t: "SOP Development",
                d: "Clear procedures for consistent and reliable security services.",
                icon: <ClipboardList />,
              },
              {
                t: "Compliance Guidance",
                d: (
                  <>
                    Support to meet UK industry regulations and{" "}
                    <Link
              ...
              {
                t: "ACS & ISO Prep",
                d: "Develop the systems needed for high-level industry certifications.",
                icon: <FileCheck />,
              },
              {
                t: "Growth Support",
                d: "Expert guidance to build credibility and win bigger contracts.",
                icon: <BarChart />,
              },
            ].map((benefit, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-[2.5rem] border border-zinc-200 hover:border-[#997819] transition-all group shadow-sm hover:shadow-xl"
              >
                <div className="text-[#997819] mb-6 group-hover:scale-110 transition-transform">
                  {benefit.icon}
                </div>
                <h3 className="font-black text-[#12066a] uppercase text-xs mb-4 tracking-tight leading-tight">
                  {benefit.t}
                </h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-[#12066a] text-4xl md:text-5xl font-black uppercase tracking-tighter mb-8">
            Who Should Start a <br />
            <span className="text-[#997819]">Private Security Startup?</span>
          </h2>
          <p className="text-zinc-600 mb-16 text-lg max-w-3xl mx-auto">
            Our consultancy is designed for individuals and organisations that
            want to establish a compliant and credible security startup while
            meeting the expectations of clients and regulators.
          </p>
          <div className="grid md:grid-cols-2 gap-6 text-left">
            {[
              <>
                Entrepreneurs planning to start a{" "}
                <Link
              ...
              <div
                key={i}
                className="flex items-center gap-4 bg-zinc-50 p-6 rounded-2xl border border-zinc-100"
              >
                <div className="w-2 h-2 rounded-full bg-[#997819]" />
                <span className="text-zinc-700 font-bold uppercase text-xs tracking-tight">
                  {item}
                </span>
              </div>
            ))}
            ...
            {[
              {
                ...
                d: "We understand your goals and market position to guide your foundation.",
              },
              {
                s: "Step 2",
                t: "Compliance Systems",
                d: (
                  <>
                    Developing essential policies aligned with{" "}
                    <Link
              ...
              {
                s: "Step 4",
                t: "Certification Prep",
                d: (
                  <>
                    Preparing your startup for{" "}
                    <Link
              ...
              <div key={i} className="relative group">
                <div className="text-6xl font-black text-white/5 absolute -top-10 left-0 group-hover:text-[#997819]/20 transition-colors">
                  0{i + 1}
                </div>
                <div className="relative z-10 pt-8 border-t border-white/10">
                  <span className="text-[#997819] font-black uppercase tracking-widest text-[10px] mb-2 block">
                    {step.s}
                  </span>
